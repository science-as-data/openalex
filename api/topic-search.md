...
The repo includes a command-line utility for querying subfields interactively.
It uses `requests` only and needs no API key. Source: [get_subfields.py](get_subfields.py).
